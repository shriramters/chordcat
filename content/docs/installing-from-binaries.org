...
Download the file named ~chordcat-0.4.0-win64.exe~ from the [[https://github.com/shriramters/chordcat/releases/tag/v0.4.0][releases page]].
...
* Debian
Download the file named ~chordcat_0.4.0_amd64.deb~ from the [[https://github.com/shriramters/chordcat/releases/tag/v0.4.0][releases page]].
...
#+begin_example bash
cd ~/Downloads
sudo apt install ./chordcat_0.4.0_amd64.deb
#+end_example
